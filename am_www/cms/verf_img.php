...
$rand_str=random_string(2);

//We memorize the md5 sum of the string into a session variable
$_SESSION['image_value'] = md5(strtoupper($rand_str));//
...
$size = 28;
imagettftext($image, $size, $angle1, 20, $size+15, $textColor1, $font1, $letter1);
imagettftext($image, $size, $angle2, 70, $size+15, $textColor2, $font2, $letter2);
//imagettftext($image, $size, $angle3, 90, $size+15, $textColor3, $font3, $letter3);
//imagettftext($image, $size, $angle4, 130, $size+15, $textColor4, $font4, $letter4);
